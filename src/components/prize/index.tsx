...
const Prize = () => {
    return (
        <section className="w-full md:my-6 my-4 lg:h-screen  h-[800px] md:rounded-3xl rounded-lg bg-[#C568DD] relative overflow-hidden">
            <div className="w-full h-full">
                <Image src={bgPattern} className="w-full h-full object-cover" alt="pattern" width={1376} height={931} quality={100} />
            </div>
            <main className='lg:px-20 md:px-10 px-4 py-10 absolute top-0 left-0 md:py-12 md:rounded-3xl rounded-lg items-center justify-center bg-[#C568DD]/70 flex flex-col h-full w-full'>
